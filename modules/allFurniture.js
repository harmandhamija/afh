...
//     const wallShelfContainer = document.querySelector('.wallshelf-container');
//     const shoeRackContainer = document.querySelector('.shoerack-container');

//     const wallShelfHeading = document.querySelector('.wallshelfs-heading');
//     const shoeRackHeading = document.querySelector('.shoeracks-heading');

//     shoeRackHeading.addEventListener('click', function () {
//         shoeRackContainer.classList.toggle('show-products');
//     })

//     wallShelfHeading.addEventListener('click', function() {
//         wallShelfContainer.classList.toggle('show-products');
//     })
// }
